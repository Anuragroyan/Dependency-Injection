...
import com.example.dependency_injection.screens.common.dialogs.DialogNavigator
import com.example.dependency_injection.screens.common.viewsmvc.ViewMvcFactory
...
class QuestionDetailsActivity<T> : BaseActivity(), QuestionDetailsViewMvc.Listener {
    private val coroutineScope = CoroutineScope(SupervisorJob() + Dispatchers.Main.immediate)

    @Inject lateinit var fetchQuestionDetailsUseCase: FetchQuestionDetailsUseCase
    @Inject lateinit var dialogsNavigator: DialogNavigator
